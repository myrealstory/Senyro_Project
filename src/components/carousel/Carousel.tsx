...
export const Carousel = ({ slides, lang, page }: CarouselProps) => {
    ...
    <div>
            ...
            return (
              <SwiperSlide key={index} style={slideViewStyle}>
                <div>
                  ...
                  <Link href={`/${lang}/${page}/${item.slug}`}>
                    <img
                      src={`${process.env.NEXT_PUBLIC_IMAGE_URL}/${item.thumbnail as string}`}
      ...
      <div className="carouselTitleSection">
        <figcaption className="carouselTitleFigcaption">
          <h2 className="">
            { mappedSlides?.[selectedItemIndex]?.title ? mappedSlides[selectedItemIndex]?.title : null }
          </h2>
          <h3 className="">
            { mappedSlides?.[selectedItemIndex]?.subtitle ? mappedSlides[selectedItemIndex]?.subtitle : null }
          </h3>
